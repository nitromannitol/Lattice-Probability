...
selects coordinate `i`.  That is `LatticeProb.iterate_delta0_eq` below, and every
...
kernel by one, which is the operator identity behind `LatticeProb.iterate_delta0_eq`. -/
